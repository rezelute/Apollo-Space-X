...
interface LoginFormProps {
  ...
  loginData: { login: string | null } | undefined;
}
...
> {
  ...
  render() {
    // if {login:null} is returned > invalid email login
    const loginMsg =
      this.props.loginData !== undefined && this.props.loginData.login === null
        ? "Invalid email login"
        : "";
